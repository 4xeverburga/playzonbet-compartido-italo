...
export interface ApiBannerBanner extends Schema.CollectionType {
  ...
  attributes: {
    ...
    userRole: Attribute.Component<'shared.user-roles', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    bonusCode: Attribute.Component<'shared.bonus-codes', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    btagCode: Attribute.Component<'shared.btag-codes', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    casinoName: Attribute.String & Attribute.Required;
    casinoDomain: Attribute.String;
    norwayApi: Attribute.String;
    webapiUrl: Attribute.String;
    casinoLogoLight: Attribute.Media;
    lobbySource: Attribute.Component<'shared.lobby-source', true>;
    gmCore: Attribute.Enumeration<['V1.0', 'V1.5']>;
    casinoLogoDark: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    seals: Attribute.Component<'shared.image-link-list', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    social: Attribute.Component<'shared.image-link-list', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    seoData: Attribute.Component<'shared.seo'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPaymentMethodPaymentMethod extends Schema.SingleType {
  ...
  attributes: {
    title: Attribute.String &
      ...
      Attribute.DefaultTo<'Owning Crypto is easy'>;
...
export interface ApiPopupPopup extends Schema.CollectionType {
  ...
  attributes: {
    ...
    audience: Attribute.Enumeration<['Public', 'Identified', 'Authenticated']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    page: Attribute.Relation<'api::popup.popup', 'oneToOne', 'api::page.page'> &
      Attribute.SetPluginOptions<{
        translate: {
          translate: 'translate';
        };
      }>;
    pageParams: Attribute.JSON &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPromotionPromotion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::promotion.promotion', 'title'>;
    ...
    btagCode: Attribute.Component<'shared.btag-codes'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPromotionSectionPromotionSection
  extends Schema.CollectionType {
  collectionName: 'promotion_sections';
  info: {
    singularName: 'promotion-section';
    pluralName: 'promotion-sections';
    displayName: 'Promotion Section';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    title: Attribute.String &
      ...
      Attribute.DefaultTo<'Main Title'>;
    description: Attribute.Text &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    audience: Attribute.Enumeration<['Public', 'Authenticated']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    btnText: Attribute.String &
      ...
      Attribute.DefaultTo<'Sign Up'>;
    CTA: Attribute.Relation<
      'api::promotion-section.promotion-section',
      'oneToOne',
      'api::page.page'
    > &
      Attribute.SetPluginOptions<{
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::promotion-section.promotion-section': ApiPromotionSectionPromotionSection;
